...
export default function RegisterPage() {
    ...
    const handleRegister = async (e) => {
        ...
        if (!registeredData.password || registeredData.password.length < 8) {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            console.error("OAuth flow provider error:", error);
            ...
            >
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                name="password"
                                placeholder="Minimum 8 characters" // প্লেসহোল্ডার টেক্সট আপডেট করা হয়েছে
                                ...
                                minLength={8} // HTML5 ন্যাটিভ ভ্যালিডেশন অ্যাড করা হয়েছে
                                required
                            />
                            <button
                                type="button"
                    ...
                    <button
                        ...
                        className="w-full py-3.5 mt-2 bg-indigo-600 text-white
